<?php
  ...
  // Default
  l::set('pagination_default_next', 'Next &rarr;');
  l::set('pagination_default_prev', '&larr; Previous');
  ...
  // Blog post
  l::set('pagination_post_next', '{{ title }} &rarr;');
  l::set('pagination_post_prev', '&larr; {{ title }}');

  // Portfolio
  l::set('pagination_portfolio_next', 'Next &rarr;');
  l::set('pagination_portfolio_prev', '&larr; Previous');
